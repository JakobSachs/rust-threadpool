...
POOL_SIZE=4 cargo run --release --bin bench-v1-simple
...
**Variants:**
- `v1_simple` - Polling with backoff, for-loop task submission
- `v2_simple_batched` - Polling with backoff, batched submission via `submit_iter()`
